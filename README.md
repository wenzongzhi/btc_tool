...
```bash
$ python btc_tool.py gen
```

- calculate hash value of string
```bash
$ python btc_tool.py hash -s "Satoshi Nakamoto"
```

```bash
$ python btc_tool.py hash -s "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks"
```

- calculate hash value of file
```bash
$ python btc_tool.py hash -f "E:\github\privatekey\bitcoin.pdf"
```

- generate public key/P2PKH/P2WPKH/P2SH-P2WPKH address 
```bash
$ python btc_tool.py addr --privhex "1415926535897932384626433832795028841971693993751058209749445923"
```